...
class VerizonMonthlyReportsScraperStrategy(MonthlyReportsScraperStrategy):
    ...
    def _find_files_section(self, config: ScraperConfig, billing_cycle: BillingCycle) -> Optional[Any]:
        ...
        try:
            ...
            # pointer events over the global nav, so the Reports tab click times
    ...
    def _dismiss_promo_modal(self) -> None:
        ...
        over the global nav, so the Reports tab click times out. Its
        ...
        This is distinct from _close_modal_if_open, which handles the Angular
        in-app modals ("reports not available yet") that appear later in the flow.
        """
